...
export const seoClusterPages: Record<string, SeoClusterPage> = {
  'rakennusyrityksille': {
    ...
    intro: 'Rakennusyrityksen kuvat ja projektifaktat muuttuvat julkaisuiksi ilman uutta markkinointiprojektia. Kerromme, miten työvaihe, valmis kohde ja tekijän osaaminen saadaan esiin käytössä olevasta työmaamateriaalista.',
    headings: {
      challenge: 'TYÖMAAKUVAT JÄÄVÄT LIIAN USEIN ARKISTOON.',
      examples: 'NÄIN RAKENNUSKOHDE MUUTTUU SISÄLLÖKSI.',
  ...
  'lvi-yrityksille': {
    ...
    intro: 'Asennus, putkiremontti tai valmis kylpyhuone kannattaa näyttää niin, että asiakas ymmärtää mitä tehtiin. Rakennamme LVI-yrityksen omista kuvista ja tarkistetuista projektitiedoista julkaisuja ilman erillistä kuvauspäivää.',
    headings: {
      challenge: 'TEKNINEN TYÖ EI NÄY ASIAKKAALLE ITSESTÄÄN.',
      examples: 'ASENNUKSESTA YMMÄRRETTÄVÄ JULKAISU.',
  ...
  'some-sisallontuotanto': {
    ...
    h1: 'Some-sisällöntuotanto yrityksen omasta työstä.', eyebrow: 'SOME-SISÄLLÖNTUOTANNON PALVELU',
    intro: 'Miten some-sisällöntuotanto kannattaa ulkoistaa? Käymme läpi materiaalin, julkaisujen suunnittelun, hyväksynnän ja kanavavalinnat. Toteutus perustuu yrityksen omiin kuviin ja tarkistettuihin projektifaktoihin. Kiinteä SOME 12 -paketti esitellään erikseen.',
    headings: {
      challenge: 'MIKSI SISÄLLÖNTUOTANTO JÄÄ KESKEN?',
      examples: 'MITÄ YRITYKSEN OMASTA TYÖSTÄ VOI JULKAISTA?',
  ...
  'instagram-sisallontuotanto': {
    ...
    intro: 'Instagram-julkaisuissa kuva, teksti ja seuraava askel muodostavat kokonaisuuden. Suunnittelemme yrityksen omista työmaa- ja referenssikuvista tunnistettavan feedin, yksittäisiä julkaisuja ja kuvakaruselleja, kun materiaali sopii niihin.',
    headings: {
  ...
  'some-12': {
    ...
    intro: 'Valmis 30 päivän sisältöpaketti: 12 alkuperäistä julkaisua yrityksen omasta materiaalista Instagramiin ja Facebookiin, suunnittelu, tekstit, kuvankäsittely, ajastus, yksi korjauskierros sekä kevyt raportti. Kiinteä hinta 490 € + ALV. Jatkosta sovitaan erikseen.',
    headings: {
