...
function VisualSystem() {
  return (
    <div
      className="content-system"
      aria-label="Hajanaiset työkuvat järjestetään kahdentoista sisällön järjestelmäksi"
    >
      ...
      <div className="content-system__arrow" aria-hidden="true">
        →
      </div>
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-8">
            ...
            <h2
              ...
              className="type-section-title mt-4 max-w-[15ch] text-ink"
            >
              HYVÄ TYÖ EI MYY, JOS SITÄ EI NÄYTETÄ.
            </h2>
          </div>
          <p className="type-editorial max-w-md text-muted lg:col-span-4">
            Työmailta syntyy jo materiaalia. Puuttuva osa on järjestelmä, joka muuttaa sen
            jatkuvaksi ja julkaisuvalmiiksi sisällöksi.
          </p>
        </div>
