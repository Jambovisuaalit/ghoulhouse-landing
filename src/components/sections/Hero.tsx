...
export default function Hero() {
  ...
  return (
    ...
    >
      <Container className="grid grid-cols-1 gap-7 py-6 sm:gap-9 sm:py-9 min-[1100px]:min-h-[calc(100svh-67px)] min-[1100px]:grid-cols-12 min-[1100px]:gap-10 min-[1100px]:py-10">
        <div className="flex flex-col justify-between min-[1100px]:col-span-7 xl:col-span-8">
          <div>
            ...
            <p className="type-editorial mt-6 text-ink/80 sm:mt-8 min-[1100px]:max-w-xl">
              <strong className="font-black text-ink">{positioning.supporting[0]}</strong>{' '}
              {positioning.supporting[1]}
            </p>
          </div>

          <div className="mt-8 sm:mt-10 min-[1100px]:mt-12">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:gap-7 min-[1100px]:gap-9">
        ...
        <figure className="min-[1100px]:col-span-5 xl:col-span-4">
          <div className="grid h-[178px] grid-cols-2 overflow-hidden border-2 border-ink sm:h-[250px] min-[1100px]:h-full min-[1100px]:min-h-[520px] min-[1100px]:grid-cols-1">
            ...
            <div className="relative overflow-hidden border-l-4 border-signal bg-bone min-[1100px]:border-l-0 min-[1100px]:border-t-4">
