      ...
      <Container>
        <div className="grid grid-cols-1 gap-9 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            <p className="type-label mb-4 text-signal-on-dark">Seuraava askel</p>
          ...
          <div className="border-t border-ghost/25 pt-6 lg:col-span-4 lg:col-start-9">
            <p className="type-editorial mb-6 max-w-md text-ghost/75">
              Lähetä yrityksen tiedot ja verkkosivu tai Instagram. Saat kaksi yrityskohtaista
              konseptiesimerkkiä siitä, miltä sisältö voisi näyttää. Työmaakuvia pyydämme vain
              tarvittaessa.
            </p>
